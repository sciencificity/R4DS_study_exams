...
The <span style="color: #008080;background-color:#9FDDBA">`facet_grid(drv ~ .)`</span> facets the `drv` categories into rows. It says facet this plot by `drv` as row panels but I don't want anything as column panels (hence the `.`).
